...
<hr>
<ol class="breadcrumb" >
<li class="breadcrumb-item"><a href="Com11English.php">English</a></li>
    <li class="breadcrumb-item"><a href="Com11Hindi.php">Hindi</a></li>
    <li class="breadcrumb-item"><a href="Com11Marathi.php">Marathi</a></li>
    <li class="breadcrumb-item"><a href="Com11BK.php">Book Keeping & Accountancy</a></li>
    <li class="breadcrumb-item"><a href="Com11OCM.php">Organisation of Commerce & Management</a></li>
    <li class="breadcrumb-item"><a href="Com11Maths.php">Mathematics & Statistics</a></li>
    <li class="breadcrumb-item"><a href="Com11SP.php">Secretarial Practice</a></li>
    <li class="breadcrumb-item"><a href="Com11IT.php">Information Technology</a></li>
    <li class="breadcrumb-item"><a href="Com11Eco.php">Economics</a></li>
  ...
  <h3 style="text-align:center">Commerce class-11th(Hindi)</h3><hr>

  <!--Subjects--><div class="accordion accordion-flush" id="accordionFlushExample">
