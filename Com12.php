...
<hr>
    <h3 style="text-align:center">Commerce class <img src="https://img.icons8.com/ios/50/000000/12.png"/></h3> <hr>
    <!--SUbjects-->
   <!--Accordion for subjects-->
   <div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    
  <a class="card1" href="Com12English.php">
    <h3>English</h3>
  ...
  <div class="col">
  <a class="card1" href="Com12Hindi.php">
    <h3>Hindi</h3>
    <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers.</p>
    <div class="go-corner" href="#">
      <div class="go-arrow">
  ...
  <div class="col">
  <a class="card1" href="Com12Marathi.php">
    <h3>Marathi</h3>
    <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers.</p>
    <div class="go-corner" href="#">
      <div class="go-arrow">
  ...
  <a class="card1" href="Com12BK.php">
  ...
  <a class="card1" href="Com12OCM.php">
  ...
  <a class="card1" href="Com12Maths.php">
  ...
  <a class="card1" href="Com12SP.php">
  ...
  <a class="card1" href="Com12IT.php">
  ...
  <a class="card1" href="Com12Eco.php">
    <h3>Economics</h3>
    <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers.</p>
    <div class="go-corner" href="#">
      <div class="go-arrow">
