...
<hr>
  <h3 style="text-align:center">Science class <img src="https://img.icons8.com/ios/50/000000/12.png"/></h3><hr>
  <div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    
  <a class="card1" href="Sci12English.php">
    <h3>English</h3>
  ...
  <div class="col">
    ...
    <a class="card1" href="Sci12Hindi.php">
      <h3>Hindi</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci12Marathi.php">
      <h3>Marathi</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci12Physics.php">
      <h3>Physics</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci12Chemistry.php">
      <h3>Chemistry</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci12Maths.php">
      <h3>Maths</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci12Biology.php">
      <h3>Biology</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci12IT.php">
    ...
    <a class="card1" href="Sci12CS.php">
    ...
    <a class="card1" href="Sci12Electronics.php">
      <h3>Electronics</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci12Economics.php">
      <h3>Economics</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
