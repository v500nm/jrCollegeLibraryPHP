       ...
       <a href="javascript:void(0)" class="closebtn" onclick="closeNav()" >&times;</a>
        ...
        <ul class="mainmenu">    
          <a href="DashboardJR.php"><img src="https://img.icons8.com/windows/28/000000/home.png"/>Dashboard</a><hr>
           ...
           <a href="Come12.php"><img src="https://img.icons8.com/windows/24/000000/chevron-right.png"/>12th COM</a>
           </ul><hr>
...
<!-- Use any element to open the sidenav -->
       ...
       <ul class="nav nav-tabs">
        <li class="nav-item">
         <a class="nav-link active" aria-current="page"><img src="https://img.icons8.com/plumpy/24/000000/menu--v1.png"/>11th Science</a>
        </li>
        <li class="nav-item">
...
<hr>
<ol class="breadcrumb" >
<li class="breadcrumb-item"><a href="Sci11English.php">English</a></li>
    <li class="breadcrumb-item"><a href="Sci11Hindi.php">Hindi</a></li>
    <li class="breadcrumb-item"><a href="Sci11Marathi.php">Marathi</a></li>
    <li class="breadcrumb-item"><a href="Sci11Physics.php">Physics</a></li>
    <li class="breadcrumb-item"><a href="Sci11Chemistry.php">Chemistry</a></li>
    <li class="breadcrumb-item"><a href="Sci11Maths.php">Maths</a></li>
    <li class="breadcrumb-item"><a href="Sci11Biology.php">Biology</a></li>
    <li class="breadcrumb-item"><a href="Sci11IT.php">IT</a></li>
    <li class="breadcrumb-item"><a href="Sci11CS.php">CS</a></li>
    <li class="breadcrumb-item"><a href="Sci11Electronics.php">Electronics</a></li>
    <li class="breadcrumb-item"><a href="Sci11Economics.php">Economics</a></li>
  ...
  <h3 style="text-align:center">Science class-11th(Hindi)</h3><hr>
