...
<hr>
<ol class="breadcrumb" >
    <li class="breadcrumb-item"><a href="Sci11.php">11th Science </a></li>
    <li class="breadcrumb-item"><a href="Sci12.php">12th Science</a></li>
  </ol>
  <style>
    .breadcrumb{
      display: flex;
...
<hr>
  <h3 style="text-align:center">Science class <img src="https://img.icons8.com/ios/50/000000/11.png"/></h3><hr>
  <!--Accordion for subjects-->
  <div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    
  <a class="card1" href="Sci11English.php">
    <h3>English</h3>
  ...
  <div class="col">
    ...
    <a class="card1" href="Sci11Hindi.php">
      <h3>Hindi</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci11Marathi.php">
      <h3>Marathi</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci11Physics.php">
      <h3>Physics</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci11Chemistry.php">
      <h3>Chemistry</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci11Maths.php">
      <h3>Maths</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci11Biology.php">
      <h3>Biology</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci11IT.php">
    ...
    <a class="card1" href="Sci11CS.php">
    ...
    <a class="card1" href="Sci11Electronics.php">
      <h3>Electronics</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
    ...
    <a class="card1" href="Sci11Economics.php">
      <h3>Economics</h3>
      <p class="small">Notes, Syllabus, Model Question papers, Previous Question papers</p>       
      <div class="go-corner" href="#">
        <div class="go-arrow">
