...
<!-- Use any element to open the sidenav -->
       ...
       <ul class="nav nav-tabs">
        <li class="nav-item">
         <a class="nav-link active" aria-current="page"><img src="https://img.icons8.com/plumpy/24/000000/menu--v1.png"/>12th Commerce</a>
        </li>
        <li class="nav-item">
...
<hr>
<ol class="breadcrumb" >
<li class="breadcrumb-item"><a href="Com12English.php">English</a></li>
    <li class="breadcrumb-item"><a href="Com12Hindi.php">Hindi</a></li>
    <li class="breadcrumb-item"><a href="Com12Marathi.php">Marathi</a></li>
    <li class="breadcrumb-item"><a href="Com12BK.php">Book Keeping & Accountancy</a></li>
    <li class="breadcrumb-item"><a href="Com12OCM.php">Organisation of Commerce & Management</a></li>
    <li class="breadcrumb-item"><a href="Com12Maths.php">Mathematics & Statistics</a></li>
    <li class="breadcrumb-item"><a href="Com12SP.php">Secretarial Practice</a></li>
    <li class="breadcrumb-item"><a href="Com12IT.php">Information Technology</a></li>
    <li class="breadcrumb-item"><a href="Com12Eco.php">Economics</a></li>
  ...
  <h3 style="text-align:center">Commerce class-12th(Organisation of Commerce & Management)</h3><hr>
